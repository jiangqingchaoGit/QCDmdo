...
@interface QCSendCardViewController ()<UITableViewDataSource,UITableViewDelegate,UIPopoverPresentationControllerDelegate>
...
@implementation QCSendCardViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    QCBookModel * model = self.dataArr[indexPath.section][indexPath.row];
    //  头像。名称 多多号 id    
    NSString * messageStr = [NSString stringWithFormat:@"%@|%@|%@|%@",model.head,model.nick,model.account,model.fuid];
    self.myBlock(messageStr);
