...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(KSCALE_WIDTH(240), KSCALE_WIDTH(0), KSCALE_WIDTH(100), KSCALE_WIDTH(46))];
        ...
        self.headerImageView = [[UIImageView alloc] initWithFrame:CGRectMake(KSCALE_WIDTH(305), KSCALE_WIDTH(4), KSCALE_WIDTH(38), KSCALE_WIDTH(38))];
        ...
        self.chooseSwitch = [[UISwitch alloc] initWithFrame:CGRectMake(KSCALE_WIDTH(300), KSCALE_WIDTH(7.5), KSCALE_WIDTH(0), KSCALE_WIDTH(0))];
