//
//  QCForgetPasswordViewController.m
//  QCDemo
//
...
@interface QCForgetPasswordViewController ()<UITextFieldDelegate>
...
@implementation QCForgetPasswordViewController
...
- (void)initUI {
    ...
    tipLabel.text = [NSString stringWithFormat:@"验证码将发送至+86 %@",self.phoneStr];
...
- (void)textFieldDidChange:(UITextField *)sender {
    ...
    if (self.codeTextField.text.length == 0 || self.passwordTextField.text.length == 0 || self.surePasswordTextField.text.length == 0) {
