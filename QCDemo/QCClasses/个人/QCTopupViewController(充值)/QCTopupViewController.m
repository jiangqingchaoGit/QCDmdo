...
//  充值
@interface QCTopupViewController ()<UITextFieldDelegate>
...
@implementation QCTopupViewController
...
- (void)loginAction:(UIButton *)sender {
    ...
    NSMutableDictionary * dic = [NSMutableDictionary dictionaryWithDictionary:@{@"red_price":self.moneyTextField.text,@"method":@"2",@"":@""}];
...
- (void)initUI {
    ...
    self.loginButton.selected = NO;
    self.loginButton.userInteractionEnabled = NO;
    [self.loginButton setTitle:@"充值" forState:UIControlStateNormal];
