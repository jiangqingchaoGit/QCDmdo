...
//    self.webSocket = [[SRWebSocket alloc] initWithURL:[NSURL URLWithString:@"https://dev-im-gateway.runxsports.com/ws/token=88888888"]];
    self.webSocket = [[SRWebSocket alloc] initWithURL:[NSURL URLWithString:@"ws://app-test.xianduoduo123.com:7272"]];
...
- (void)webSocket:(SRWebSocket *)webSocket didReceiveMessage:(id)pongData{
    ...
    NSLog(@"%@",[QCClassFunction AES128_Decrypt:@"5961260030843025" withStr:@"mkuaMaiiwrqxkS5A/uVpdu4doNGkI1T//T7wV3w5Z+JMyKBwpavboCce7hOFQ+drWuY18gpcxeGKSxqSLv5QczK6rBnHEFawF0mIq4dUino="]);
}
